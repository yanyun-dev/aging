...
#define	IQ_PI_MIN				300						//Minimum Duty Cycle to start the motor
#define	IQ_PI_MAX				2450					//Maximum Duty Cycle (98% of 2500 ticks - based on a 20 KHz Switching Frequency)
...
// Speed PI Loop Gains
#define SPEED_PI_TD				FIX16(1024 / 1000)		// 1 ms * 1024 in fix16 format
#define	SPEED_PI_KP				FIX16(2.0)
#define	SPEED_PI_KI				FIX16(9.0)
#define	SPEED_PI_MIN			-500
#define	SPEED_PI_MAX			800
...
#define	IQ_PI_KI				FIX16(3.0)
#define	IQ_PI_MIN				100						//Minimum Duty Cycle to start the motor
#define	IQ_PI_MAX				995						//Maximum Duty Cycle (98% of 2500 ticks - based on a 20 KHz Switching Frequency)

#define	START_BLANKING_CYCLES	15
#define	START_GOOD_SAMPLES		5

#define START_IQ_REF_DEF		50
#define ALIGN_TIME_MS_DEF		50
#define OL_START_HZ_DEF			20
...
#define OL_SWITCHOVER_HZ_DEF	60

#define DEFAULT_OL_ACCEL_PERIOD	3						//Number of ms between speed increase during Open Loop Mode
#define DEFAULT_OL_ACCEL_INC	1						//Number of Hz for the speed increase during Open Loop Mode
#define DEFAULT_CL_ACCEL_PERIOD	1						//Number of ms between speed increase during Closed Loop Mode
#define DEFAULT_CL_ACCEL_INC	3						//Number of Hz for the speed increase during Closed Loop Mode

#define	RUN_BLANKING_CYCLES		5						//Blanking period in TIMER C Cycles
#define	RUN_GOOD_SAMPLES		1						//Number of good samples (in TIMER C Cycles) to acknowledge a BEMF transition
...
#define	SCALE_PERCENT 			FIX16(0.20)				// Sine Wave Commutation Scaling Factor
