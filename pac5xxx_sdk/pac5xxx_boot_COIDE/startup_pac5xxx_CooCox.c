...
/*----------Stack Configuration-----------------------------------------------*/  
#define STACK_SIZE       0x00000090      /*!< Stack size (in Words)           */
...
extern void set_pll_and_test_flash_crc(void);

void Initial_Reset_Handler(void) __attribute__( ( naked ) );
void Initial_Reset_Handler(void)
{
    ...
    set_pll_and_test_flash_crc();

    // Put Stack pointer back
    __set_MSP((uint32_t)&pulStack[STACK_SIZE]);
...
#pragma weak Reset_Handler = Initial_Reset_Handler
